...
namespace AlecRabbit\Tests\Spinner\Extras\Unit\Color;
...
//        dump($s);
    ...
    {
        $e = new InvalidArgument('Number of colors must be greater than 2.');
    ...
    {
        $e = new InvalidArgument('Number of colors must be less than 5.');
