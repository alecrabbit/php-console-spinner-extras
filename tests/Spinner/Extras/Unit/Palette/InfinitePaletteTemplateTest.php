...
namespace AlecRabbit\Tests\Spinner\Extras\Unit\Palette;
...
final class InfinitePaletteTemplateTest extends TestCase
{
    ...
    public function canBeInstantiated(): void
    {
        ...
        self::assertInstanceOf(InfinitePaletteTemplate::class, $palette);
    }
