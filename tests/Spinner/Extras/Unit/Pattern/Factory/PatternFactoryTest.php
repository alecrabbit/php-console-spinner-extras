...
namespace AlecRabbit\Tests\Spinner\Extras\Unit\Pattern\Factory;
...
final class PatternFactoryTest extends TestCase
{
    ...
    public function canCreateFromInfinitePalette(): void
    {
        ...
        $template = $this->getInfinitePaletteTemplateMock();
        $template
            ->expects(self::once())
            ->method('getEntries')
            ->willReturn($entries)
        ...
        self::assertInstanceOf(InfinitePattern::class, $pattern);
