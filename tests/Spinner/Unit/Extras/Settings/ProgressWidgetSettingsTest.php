...
final class ProgressWidgetSettingsTest extends TestCase
{
    ...
    public function canBeInstantiated(): void
    {
        ...
        self::assertInstanceOf(MultiWidgetSettings::class, $settings);
    }

    private function getTesteeInstance(
        IWidgetSettings $first = null,
        IWidgetSettings ...$other,
    ): IMultiWidgetSettings {
        return new MultiWidgetSettings(
    ...
    public function canGetIdentifier(): void
    {
        ...
        self::assertSame(IMultiWidgetSettings::class, $settings->getIdentifier());
    }
